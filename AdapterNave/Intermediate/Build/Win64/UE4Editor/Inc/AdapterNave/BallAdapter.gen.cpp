...
#include "AdapterNave/BallAdapter.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	ADAPTERNAVE_API UClass* Z_Construct_UClass_ABallAdapter();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_AdapterNave();
	ADAPTERNAVE_API UClass* Z_Construct_UClass_ABall_NoRegister();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABallAdapter_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ABallAdapter_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UBounceBallInterface_NoRegister, (int32)VTABLE_OFFSET(ABallAdapter, IBounceBallInterface), false },
		};
	...
	IMPLEMENT_CLASS(ABallAdapter, 3917995982);
	template<> ADAPTERNAVE_API UClass* StaticClass<ABallAdapter>()
	{
		return ABallAdapter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABallAdapter(Z_Construct_UClass_ABallAdapter, &ABallAdapter::StaticClass, TEXT("/Script/AdapterNave"), TEXT("ABallAdapter"), false, nullptr, nullptr, nullptr);
